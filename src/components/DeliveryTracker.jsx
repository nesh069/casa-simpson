    ...
    <div className="w-full py-6">
      <div className="flex items-center justify-between relative">
        <div className="absolute top-5 left-0 right-0 h-1 bg-border z-0">
          <div
            className="h-full bg-brand transition-all duration-700 shadow-[0_0_8px_rgba(255,71,87,0.6)]"
          ...
          return (
            <div key={step.id} className="flex flex-col items-center z-10 flex-1">
              <div className={`w-10 h-10 rounded-full flex items-center justify-center text-lg border-2 transition-all duration-300 ${
                isComplete
                  ? 'bg-brand border-brand shadow-[0_0_12px_rgba(255,71,87,0.5)]'
                  : isActive
                  ? 'bg-card border-brand shadow-[0_0_12px_rgba(255,71,87,0.3)]'
